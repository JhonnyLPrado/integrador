...
<html class="no-js"> 
	...
	<a href="<?php echo e(route('login')); ?>"><span>Ingresar</span></a>
</li>
	...
	<section id="fh5co-home" data-section="home" style="background-image: url(<?php echo e(asset('images/fondo_01.jpg')); ?>);" data-stellar-background-ratio="0.5">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							...
							<div class="call-to-action">
								<a href="<?php echo e(route('login')); ?>" class="demo to-animate">Descargar</a>
								<a href="<?php echo e(route('login')); ?>" class="download to-animate">Plataformas</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-push-5 to-animate-2">
						<img class="img-responsive" src="<?php echo e(asset('images/OIP.jpg')); ?>" alt="work">
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-pull-1 to-animate-3">
						<img class="img-responsive" src="<?php echo e(asset('images/punto.jpg')); ?>" alt="work">
					</div>
				...
				<div class="row">
					 <div class="col-md-2 col-sm-3 col-xs-6 col-sm-offset-0 col-md-offset-1">
					 	<div class="partner-logo to-animate-2">
					 		<img src="<?php echo e(asset('images/logo 1.png')); ?>" alt="Partners" class="img-responsive">
					 	</div>
					 </div>
				    <div class="col-md-2 col-sm-3 col-xs-6">
				    	<div class="partner-logo to-animate-2">
				    		<img src="<?php echo e(asset('images/logo 2.png')); ?>" alt="Partners" class="img-responsive">
						</div>
				    </div>
				    <div class="col-md-2 col-sm-3 col-xs-6">
				    	<div class="partner-logo to-animate-2">
				    		<img src="<?php echo e(asset('images/logo 3.png')); ?>" alt="Partners" class="img-responsive">
				    	</div>
				    </div>
				    <div class="col-md-2 col-sm-3 col-xs-6">
				    	<div class="partner-logo to-animate-2">
				    		<img src="<?php echo e(asset('images/logo 4.png')); ?>" alt="Partners" class="img-responsive">
				    	</div>
				    </div>
				    <div class="col-md-2 col-sm-12 col-xs-12">
				    	<div class="partner-logo to-animate-2">
				    		<img src="<?php echo e(asset('images/logo 5.png')); ?>" alt="Partners" class="img-responsive">
				    	</div>
				    </div>
				</div>
			</div>
...
<?php /**PATH C:\laragon\www\integrador\resources\views/welcome.blade.php ENDPATH**/ ?>