                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apellido_paterno" id="apellido_paterno" class="form-control @error('apellido_paterno') is-invalid @enderror" value="{{ old('apellido_paterno') }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apellido_materno" id="apellido_materno" class="form-control @error('apellido_materno') is-invalid @enderror" value="{{ old('apellido_materno') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="ci" id="ci" class="form-control @error('ci') is-invalid @enderror" value="{{ old('ci') }}" required pattern="[0-9]+" title="Por favor ingrese solo números">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="expedido" id="expedido" class="form-control @error('expedido') is-invalid @enderror" required>
                                        ...
                                        @foreach(\App\Models\Registro::getDepartamentosBolivia() as $key => $departamento)
                                            <option value="{{ $key }}" {{ old('expedido') == $key ? 'selected' : '' }}>{{ $departamento }}</option>
                                        @endforeach
                                    </select>
                                    @error('expedido')
                                        <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="estado_civil" id="estado_civil" class="form-control @error('estado_civil') is-invalid @enderror" required>
                                        ...
                                        @foreach(\App\Models\Registro::getEstadosCiviles() as $key => $estado)
                                            <option value="{{ $key }}" {{ old('estado_civil') == $key ? 'selected' : '' }}>{{ $estado }}</option>
                                        @endforeach
                                    </select>
                                    @error('estado_civil')
                                        <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="profesion" id="profesion" class="form-control @error('profesion') is-invalid @enderror" value="{{ old('profesion') }}" placeholder="Ej: Comerciante, Estudiante, etc.">
                                    @error('profesion')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="domicilio" id="domicilio" class="form-control @error('domicilio') is-invalid @enderror" rows="2" required placeholder="Dirección completa del domicilio">{{ old('domicilio') }}</textarea>
                                    @error('domicilio')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cargo" id="cargo" class="form-control @error('cargo') is-invalid @enderror" value="{{ old('cargo') }}" required placeholder="Ej: Robo, Hurto, Violencia doméstica, etc.">
                                    @error('cargo')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control @error('descripcion') is-invalid @enderror" rows="3" placeholder="Descripción detallada del incidente">{{ old('descripcion') }}</textarea>
                                    @error('descripcion')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="antecedentes" id="antecedentes" class="form-control @error('antecedentes') is-invalid @enderror" rows="6" readonly placeholder="Los antecedentes aparecerán aquí cuando busque por CI..."></textarea>
                                    @error('antecedentes')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
        ...
        document.getElementById('buscarAntecedentes').addEventListener('click', async function() {
            ...
            try {
                ...
                if (data.length === 0) {
                    ...
                    // Llenar automáticamente los campos personales con el primer registro encontrado
                    const primerRegistro = data[0];
                    document.getElementById('nombres').value = primerRegistro.nombres || '';
                    document.getElementById('apellido_paterno').value = primerRegistro.apellido_paterno || '';
                    document.getElementById('apellido_materno').value = primerRegistro.apellido_materno || '';
                    document.getElementById('expedido').value = primerRegistro.expedido || '';
                    document.getElementById('fecha_nacimiento').value = primerRegistro.fecha_nacimiento || '';
                    document.getElementById('estado_civil').value = primerRegistro.estado_civil || '';
                    document.getElementById('profesion').value = primerRegistro.profesion || '';
                    document.getElementById('domicilio').value = primerRegistro.domicilio || '';
